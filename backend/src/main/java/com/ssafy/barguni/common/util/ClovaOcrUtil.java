...
//    public void getOcr(MultipartFile multipartFile) {
//        try {
...
//            File tmp = new File(uploadFolder + multipartFile.getOriginalFilename());
//            tmp.createNewFile();
...
//        // 위의 라이브러리를 해야 작동. org.json.JSON~ 과 제공하는 함수가 다름.
//        try {
